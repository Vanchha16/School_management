                ...
                <ul class="dropdown-menu dropdown-menu-end border-0 shadow rounded-4 p-2 mt-2 language-menu">
                    <li>
                        <a class="dropdown-item rounded-3 text-center py-2" href="{{ route('language.switch', 'en') }}"
                            title="English">
                            <img src="{{ asset('assets/img/united-states-of-america.png') }}" alt="English" width="28"
                                height="28" class="rounded-circle">English
                        </a>
                    </li>
                    <li>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="item_id" name="item_id" placeholder="{{ __('app.Search or type item...') }}" required>
                            ...
                            @foreach ($items as $item)
                                <option value="{{ $item->Itemid }}" data-name="{{ $item->name }}"
            ...
            new TomSelect("#item_id", {
                ...
                onChange: function(value) {
                    ...
                    if (option && option.image) {
                        ...
                        previewImage.src = ''
                        previewName.textContent = this.getValue()
                        itemPreview.style.display = this.getValue() ? 'block' : 'none'
