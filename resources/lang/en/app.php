...
return [
    ...
    'Restored records return to the active borrow list.' => 'Restored records return to the active borrow list.',
    ...
    'The password is incorrect password' => 'The password is incorrect password',
